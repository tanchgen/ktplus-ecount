...
// Сообщения от электросчетчика
  ...
  WGAIN_N = 0x19,           // Коэффициент коррекции мощности - Фаза N
	WATT_SEND_TOUT = 0x1A,    // Интервал отправки данных

	// От S207 - задаются параметры, к S207 - превышены значения параметров
	WATT_MAX  = 0x1B,         // Максимум потребляемой мощности
	CUR_MAX = 0x1C,           // Максимальный ток в цепи
	VOLT_MAX = 0x1D,          // Максимальное напряжение в цепи
